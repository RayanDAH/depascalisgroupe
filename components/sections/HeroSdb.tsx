...
export default function HeroSdb({
  backgroundImage,
  title = '',
  highlightWord = '',
  subtitle = '',
            ...
            {reassuranceItems.length > 0 && (
              ...
              >
                {reassuranceItems.map((item, index) => (
                  <div
                    key={index}
                    className="flex items-center gap-2 rounded-lg border border-white/10 bg-black/20 px-4 py-[6px] backdrop-blur-sm"
                  >
